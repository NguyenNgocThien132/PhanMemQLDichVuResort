...
namespace GUI
{
    public partial class FrmThongKeDoanhThu : Form
    {
        ...
        DLL_DoiPhong doiphongdll = new DLL_DoiPhong();
        ...
        private void btnInBaoCao_Click(object sender, EventArgs e)
        {
            ...
            // Tìm vị trí của chuỗi "năm" trong labelText
            int indexxx = labelText.IndexOf("năm");

            if (indexxx != -1)
            {
                // Lấy đoạn chuỗi sau vị trí "năm" và loại bỏ các ký tự không phải là số
            ...
            if (thang!= "" && labelText.Contains("Tháng"))
            {
                ...
                BaoCaoTongQuan bc = new BaoCaoTongQuan(index, taikhoan, thang, double.Parse(doanhthu_));
                bc.CreateDocument();
                bc.ShowPreview();
            }
        ...
        private void btnXuatDT_Click(object sender, EventArgs e)
        {
            ...
            if (cbbthongke == "Theo ngày")
            {
                ...
                BaoCaoDatPhong bc = new BaoCaoDatPhong(tbHoaDon, taikhoan, cbbthongke, cbbthongketheo, sohoadon, tongtien, "Hóa đơn");
                bc.CreateDocument();
                bc.ShowPreview();
            }
        ...
        private void btnXuatDV_Click(object sender, EventArgs e)
        {
            ...
            if (cbbthongke == "Theo ngày")
            {
                ...
                BaoCaoDatPhong bc = new BaoCaoDatPhong(tbDichVu, taikhoan, cbbthongke, cbbthongketheo, sohoadon, tongtien, "Dịch vụ");
                bc.CreateDocument();
                bc.ShowPreview();
            }
            if (cbbthongke == "Theo Tháng")
        ...
        private void btnXuatTB_Click(object sender, EventArgs e)
        {
            ...
            if (cbbthongke == "Theo ngày")
            {
                ...
                BaoCaoDatPhong bc = new BaoCaoDatPhong(tbDichVu, taikhoan, cbbthongke, cbbthongketheo, sohoadon, tongtien, "Thiết bị");
                bc.CreateDocument();
                bc.ShowPreview();
            }
            if (cbbthongke == "Theo Tháng")
